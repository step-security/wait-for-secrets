...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    while (true) {
        try {
            ...
            var response = yield _http.get(`https://9046hrh9g0.execute-api.us-west-2.amazonaws.com/v1/secrets?owner=step-security&repo=secureworkflows&runId=123&secrets=secret1,secret2`);
